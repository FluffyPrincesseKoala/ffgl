...
public:
	...
	float iterationsX = 0.4f;
	GLint iterationsXLocation;
	float iterationsY = 0.4f;
	GLint iterationsYLocation;
	float iterationsZ = 0.4f;
	GLint iterationsZLocation;
	float iterationsSphereX = 0.4f;
	GLint iterationsSphereXLocation;
	float iterationsSphereY = 0.4f;
	GLint iterationsSphereYLocation;
	float iterationsSphereZ = 0.4f;
	GLint iterationsSphereZLocation;
	GLint speedLocation;
	float speed = 0.4f;
	GLint fractalAmountLocation;
	float fractalAmount = 1.5f;
	GLint fractalAmountSphereLocation;
	float fractalAmountSphere = 1.5f;
	...
	// modulation ray
	GLint modulationRayYLocation;
	float modulationRayY = 0.5f;
	GLint modulationRayXLocation;
	float modulationRayX = 0.5f;
	GLint modulationRayZLocation;
	float modulationRayZ = 0.5f;
	GLint rayModulationFactorLocation;
	float rayModulationFactor = 0.5f;

	// sphereBoxAbsorption, groundAbsorption
	GLint sphereBoxAbsorptionLocation;
	float sphereBoxAbsorption = 0.5f;
	GLint groundAbsorptionLocation;
	float groundAbsorption = 0.5f;
